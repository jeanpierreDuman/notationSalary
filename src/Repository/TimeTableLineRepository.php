...
/**
 * @extends ServiceEntityRepository<TimeTableLine>
 *
...
class TimeTableLineRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(TimeTableLine $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(TimeTableLine $entity, bool $flush = true): void
    {
